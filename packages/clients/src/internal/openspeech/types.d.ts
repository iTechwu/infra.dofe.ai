 ...
 * 流式语音识别状态
 */
export type StreamingAsrStatus = 'connecting' | 'connected' | 'streaming' | 'completed' | 'error' | 'disconnected';
/**
 * 支持的语言代码
 * @see https://www.volcengine.com/docs/6561/1354869
 */
export type StreamingAsrLanguage = '' | 'en-US' | 'ja-JP' | 'ko-KR' | 'id-ID' | 'es-MX' | 'pt-BR' | 'de-DE' | 'fr-FR' | 'fil-PH' | 'ms-MY' | 'th-TH' | 'ar-SA';
/**
 * 热词配置
 */
