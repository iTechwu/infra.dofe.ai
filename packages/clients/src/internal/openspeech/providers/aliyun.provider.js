...
exports.AliyunOpenspeechProvider = void 0;
 ...
 * ```
 */
class AliyunOpenspeechProvider extends base_provider_1.BaseOpenspeechProvider {
    config;
    /**
     * 云服务商标识：阿里云 OSS
     * @readonly
    ...
    async submitTask(params) {
        ...
        if (!this.config.accessKeyId || !this.config.accessKeySecret) {
            throw new Error('Aliyun OpenSpeech config missing accessKeyId or accessKeySecret');
        }
        ...
        try {
            ...
            const webhookUrl = callbackUrl ||
                `${enviroment_util_1.default.generateEnvironmentUrls().api}/webhook/audio-transcribe/oss`;
            // 构建任务参数
...
exports.AliyunOpenspeechProvider = AliyunOpenspeechProvider;
