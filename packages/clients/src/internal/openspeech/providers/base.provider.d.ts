...
import { IOpenspeechProvider, SubmitTaskParams, TaskStatusResult } from '../types';
/**
 * 语音识别服务提供商抽象基类
 *
 ...
 * ```
 */
export declare abstract class BaseOpenspeechProvider implements IOpenspeechProvider {
