...
import { SubmitTaskResult, TaskStatusResult, StreamingConnectParams, StreamingAsrCallbacks, StreamingAsrStatus, IStreamingAsrProvider } from './types';
/**
 ...
 * ```
 */
export declare class OpenspeechClient {
     ...
     */
    constructor(fileApi: FileStorageService, providerFactory: OpenspeechProviderFactory, logger: Logger);
    /**
     * 根据 FileKey 提交语音识别任务
     *
     ...
     * ```
     */
    submitTranscribeTask(fileKey: Partial<FileSource>): Promise<SubmitTaskResult>;
    /**
     * 查询语音识别任务状态
     *
     ...
     * ```
     */
    queryTranscribeTaskStatus(vendor: FileBucketVendor, vendorTaskId: string): Promise<TaskStatusResult>;
    /**
     ...
     * ```
     */
    transcribeFromFileKey(fileKey: Partial<FileSource>): Promise<string>;
    /**
     * 建立流式语音识别连接
     *
     ...
     * ```
     */
    connectStreaming(vendor: FileBucketVendor, params: StreamingConnectParams, callbacks: StreamingAsrCallbacks): Promise<string>;
    /**
     * 发送音频数据到流式识别连接
     *
     ...
     * ```
     */
    sendStreamingAudio(vendor: FileBucketVendor, connectionId: string, audioData: Buffer, isLast?: boolean): Promise<void>;
    /**
     * 关闭流式识别连接
     *
     * @param {FileBucketVendor} vendor - 云服务商类型
     ...
     * ```
     */
    disconnectStreaming(vendor: FileBucketVendor, connectionId: string): Promise<void>;
    /**
     * 获取流式识别连接状态
     *
     * @param {FileBucketVendor} vendor - 云服务商类型
     ...
     * ```
     */
    getStreamingStatus(vendor: FileBucketVendor, connectionId: string): StreamingAsrStatus;
    /**
     * 获取流式识别提供商实例
     *
