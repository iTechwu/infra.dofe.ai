...
const exchange_rate_client_1 = require("./exchange-rate.client");
...
exports.ExchangeRateModule = ExchangeRateModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [exchange_rate_client_1.ExchangeRateClient],
        exports: [exchange_rate_client_1.ExchangeRateClient],
    })
], ExchangeRateModule);
