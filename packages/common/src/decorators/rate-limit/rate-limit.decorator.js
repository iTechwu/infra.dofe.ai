...
exports.RateLimitStrict = exports.RateLimitSensitive = exports.RateLimitLow = exports.RateLimitStandard = exports.RateLimitHigh = exports.RateLimitPresets = exports.SKIP_RATE_LIMIT_KEY = exports.RATE_LIMIT_KEY = void 0;
...
function RateLimit(options) {
    return (0, common_1.applyDecorators)((0, common_1.SetMetadata)(exports.RATE_LIMIT_KEY, options), (0, common_1.UseInterceptors)(rate_limit_interceptor_1.RateLimitInterceptor));
}
/**
 * @SkipRateLimit - 跳过限流
 *
...
function SkipRateLimit() {
    return (0, common_1.SetMetadata)(exports.SKIP_RATE_LIMIT_KEY, true);
}
// ============================================================================
// Preset Decorators
// ============================================================================
 ...
 */
exports.RateLimitHigh = exports.RateLimitPresets.high;
/**
 * @RateLimitStandard - 标准接口限流 (100/分钟)
 */
exports.RateLimitStandard = exports.RateLimitPresets.standard;
/**
 * @RateLimitLow - 低频接口限流 (20/分钟)
 */
exports.RateLimitLow = exports.RateLimitPresets.low;
/**
 * @RateLimitSensitive - 敏感操作限流 (5/分钟)
 */
exports.RateLimitSensitive = exports.RateLimitPresets.sensitive;
/**
 * @RateLimitStrict - 严格限流 (10/小时)
 */
exports.RateLimitStrict = exports.RateLimitPresets.strict;
