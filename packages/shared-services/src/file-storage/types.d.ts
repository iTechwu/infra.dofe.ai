...
import { DoFeUploader } from "../../../clients/src/internal/file-storage";
/**
 * 文件位置标识
 *
 ...
 * @returns 缓存键
 */
export declare function buildStorageClientKey(vendor: FileBucketVendor, bucket: string): StorageClientKey;
/**
 * 文件复制参数
 *
 ...
 * 存储供应商类型到客户端类的映射
 */
export type VendorClientMapping = Record<FileBucketVendor, new (...args: any[]) => any>;
/**
 * 存储凭证配置映射
 */
