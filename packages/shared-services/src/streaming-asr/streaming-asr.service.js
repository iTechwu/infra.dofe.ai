...
const openspeech_1 = require("../../../clients/src/internal/openspeech");
...
let StreamingAsrService = class StreamingAsrService {
     ...
     */
    initProvider() {
        const openspeechConfig = (0, configuration_1.getKeysConfig)()?.openspeech;
        ...
        this.provider = new openspeech_1.VolcengineStreamingAsrProvider(this.logger, config);
        if (enviroment_util_1.default.isProduction()) {
