 ...
 */
import { StreamingAsrStatus as ProviderStatus } from "../../../clients/src/internal/openspeech";
/**
 * 流式识别会话状态
 */
 ...
 * SSE 事件类型
 */
export type StreamingAsrEventType = 'connected' | 'transcript' | 'error' | 'completed' | 'disconnected' | 'duration-exceeded';
/**
 * SSE 事件数据
 */
export interface StreamingAsrEvent {
    ...
    sessionId: string;
    /** 事件数据 */
    data?: StreamingTranscriptUpdate | {
        error: string;
