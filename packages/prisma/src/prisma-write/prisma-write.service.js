...
let PrismaWriteService = class PrismaWriteService {
    ...
    validatePrismaClient(client, clientType) {
        ...
        if (missingModels.length > 0) {
            this.logger.warn(`[PrismaWriteService] ${clientType} client missing models/methods: ${missingModels.join(', ')}`);
            return false;
        }
        return true;
    }
...
exports.PrismaWriteService = PrismaWriteService = __decorate([
