 ...
 * 删除操作列表
 */
exports.DELETE_ACTIONS = ['delete', 'deleteMany'];
/**
    ...
    return prisma.$extends({
        query: {
            $allOperations({ operation, model, args, query }) {
                ...
                if (exports.QUERY_ACTIONS.includes(operation)) {
                    const newArgs = { ...args };
                    if (!newArgs.where) {
                        newArgs.where = {};
                    }
